const zhHansTranslations = {
  ...
  editorAiShorten: "精简",
  editorAiLonger: "扩写",
  editorAiProfessional: "正式",
  editorAiInputPlaceholder: "自定义要求...",
  ...
  settingsAdvancedJsonNotice:
    "系统已强制关闭模型思考并要求 JSON 输出，此处仅用于微调语气与偏好。",
  settingsCustomPrompt: "自定义 Prompt",
  settingsPromptTip: "默认提示词已满足常用场景，仅在需要微调语气或风格时修改。",
  settingsGreetingPrompt: "欢迎语 Prompt",
  settingsGreetingPromptTip: "调整主界面顶部欢迎语的语气和风格。",
  settingsTemperature: "温度（0-1）",
  settingsTemperaturePlaceholder: "例如 1.0",
  settingsTemperatureTip: "建议从 1.0 开始；越低越稳定，越高越发散。",
  settingsMaxTokens: "最大输出 Tokens",
  settingsMaxTokensPlaceholder: "例如 60",
  settingsMaxTokensTip: "建议保持精简输出，常用场景约 60 tokens。",
