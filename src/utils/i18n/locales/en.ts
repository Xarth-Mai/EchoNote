const enTranslations = {
  ...
  editorAiPolish: "Polish",
  editorAiShorten: "Shorten",
  editorAiLonger: "Longer",
  editorAiProfessional: "Professional",
  editorAiInputPlaceholder: "Custom instruction...",
  ...
  settingsModelTip: "It's recommended to use a fast model, such as gpt-5.1-nano. If you use a reasoning model, please increase the token limit in the advanced settings.",
